...
public class PaymentsService : IPaymentsService
{
    ...
    public async Task<ApiResponse> PaymentPost(_Customer c, PaymentBase.PaymentEntries entryClass, double amount, _Check check, string description)
    {
        var requestData = new
        {
            city = "XXXX",
    ...
    public async Task<ApiResponse> PaymentPostWithToken(_Customer c, PaymentBase.PaymentEntries entryClass, double amount, _Check check, string description)
    {
        var requestData = new
        {
            city = "XXXX",
